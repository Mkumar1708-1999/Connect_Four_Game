...
public class HelloApplication extends Application {
    ...
    private void aboutMe()
    {
        ...
        alert.setHeaderText("Mayashankar Kumar");
        alert.setContentText("Hi! I am Mayashankar, a developer focused on backend developer" +
                ...
                " design/development since 2016 when  i was started my diploma. " +
                "I enjoy creating beautifully designed, intuitive and " +
                "functional applications & websites. Being an Engineer" +
                " I believe in using science to find creative practical solutions." +
                " My hobbies includes Coding , Riding  & Travelling.");
